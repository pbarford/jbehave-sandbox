...
public class GoogleSearchStories extends JUnitStories {
	...
	public InjectableStepsFactory stepsFactory() {
		ApplicationContext context = new SpringApplicationContextFactory("app-google-context.xml").createApplicationContext();
	...
	protected List<String> storyPaths() {
		return new StoryFinder().findPaths(
				codeLocationFromClass(this.getClass()).getFile(), asList("**/"
						+ System.getProperty("storyFilter", "*") + "GoogleSearch.story"), null);
	}
}
