package com.pjb.sandbox.jbehave.stories;
...
public class YahooSearchStories extends JUnitStories {
	...
	StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
			.withCodeLocation(codeLocationFromClass(YahooSearchStories.class))
	...
	public Configuration configuration() {
		return new SeleniumConfiguration()
				...
				.useStoryLoader(new LoadFromClasspath(YahooSearchStories.class))
				.useStoryReporterBuilder(reporterBuilder);
	}

	@Override
	public InjectableStepsFactory stepsFactory() {
		ApplicationContext context = new SpringApplicationContextFactory("app-yahoo-context.xml").createApplicationContext();
	...
	protected List<String> storyPaths() {
		return new StoryFinder().findPaths(
				codeLocationFromClass(this.getClass()).getFile(), asList("**/"
						+ System.getProperty("storyFilter", "*") + "YahooSearch.story"), null);
	}
}
